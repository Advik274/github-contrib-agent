...
class OnboardingWizard:
    ...
    def _show_step_0(self):
        ...
        tk.Label(self.content_frame, text="🤖",
                 font=("Segoe UI", 48),
                 bg="#0d1117", fg="#58a6ff").pack(pady=(20, 10))
        ...
        tk.Label(self.content_frame,
                 ...
                 font=("Segoe UI", 10),
                 bg="#0d1117", fg="#8b949e").pack(pady=(5, 30))
        ...
        for icon, text in features:
            tk.Label(self.content_frame, text=f"{icon}  {text}",
                     font=("Segoe UI", 11),
                     bg="#0d1117", fg="#c9d1d9").pack(pady=4)
        ...
        tk.Button(btn_frame, text="Get Started →",
                  ...
                  command=self._show_step_1).pack()
    ...
    def _show_step_1(self):
        ...
        tk.Label(self.content_frame, text="Step 1: GitHub Token",
        ...
        tk.Label(self.content_frame,
                 ...
                 font=("Segoe UI", 9),
                 bg="#0d1117", fg="#8b949e", wraplength=450).pack(anchor="w", pady=(0, 15))

        tk.Label(self.content_frame, text="1. Go to github.com/settings/tokens",
                 font=("Segoe UI", 9),
                 bg="#0d1117", fg="#c9d1d9").pack(anchor="w")
        tk.Label(self.content_frame, text="2. Click 'Generate new token (classic)'",
                 font=("Segoe UI", 9),
                 bg="#0d1117", fg="#c9d1d9").pack(anchor="w")
        tk.Label(self.content_frame, text="3. Check the 'repo' scope",
                 font=("Segoe UI", 9),
                 bg="#0d1117", fg="#c9d1d9").pack(anchor="w")
        tk.Label(self.content_frame, text="4. Copy the generated token",
                 font=("Segoe UI", 9),
                 bg="#0d1117", fg="#c9d1d9").pack(anchor="w", pady=(0, 15))

        tk.Label(self.content_frame, text="Your GitHub Token:",
                 font=("Segoe UI", 9, "bold"),
                 bg="#0d1117", fg="#8b949e").pack(anchor="w")

        self.token_entry = tk.Entry(self.content_frame, width=50,
                                     font=("Consolas", 10),
                                     bg="#161b22", fg="#c9d1d9",
        ...
        tk.Label(self.content_frame, text="GitHub Username:",
                 font=("Segoe UI", 9, "bold"),
                 bg="#0d1117", fg="#8b949e").pack(anchor="w", pady=(15, 0))

        self.username_entry = tk.Entry(self.content_frame, width=50,
                                       font=("Consolas", 10),
                                       bg="#161b22", fg="#c9d1d9",
                                       insertbackground="white",
                                       relief="flat", bd=0)
    ...
    def _show_step_2(self):
        ...
        tk.Label(self.content_frame, text="Step 2: Mistral API Key",
                 font=("Segoe UI", 16, "bold"),
                 bg="#0d1117", fg="#e6edf3").pack(anchor="w", pady=(0, 5))
        ...
        tk.Label(self.content_frame, text="1. Go to console.mistral.ai",
                 font=("Segoe UI", 9),
                 bg="#0d1117", fg="#c9d1d9").pack(anchor="w")
        tk.Label(self.content_frame, text="2. Create an account or sign in",
                 font=("Segoe UI", 9),
                 bg="#0d1117", fg="#c9d1d9").pack(anchor="w")
        tk.Label(self.content_frame, text="3. Go to API Keys section",
                 font=("Segoe UI", 9),
                 bg="#0d1117", fg="#c9d1d9").pack(anchor="w")
        tk.Label(self.content_frame, text="4. Create a new API key and copy it",
                 font=("Segoe UI", 9),
                 bg="#0d1117", fg="#c9d1d9").pack(anchor="w", pady=(0, 15))

        tk.Label(self.content_frame, text="Your Mistral API Key:",
                 font=("Segoe UI", 9, "bold"),
                 bg="#0d1117", fg="#8b949e").pack(anchor="w")

        self.mistral_entry = tk.Entry(self.content_frame, width=50,
                                       font=("Consolas", 10),
                                       bg="#161b22", fg="#c9d1d9",
                                       insertbackground="white",
                                       relief="flat", bd=0)
    ...
    def _show_step_3(self):
        ...
        tk.Label(self.content_frame, text="Step 3: Ready to Go!",
                 font=("Segoe UI", 16, "bold"),
                 bg="#0d1117", fg="#e6edf3").pack(anchor="w", pady=(0, 5))
        ...
        tk.Label(self.content_frame,
                 ...
                 font=("Segoe UI", 9),
                 bg="#0d1117", fg="#8b949e", wraplength=450).pack(anchor="w", pady=(0, 20))

        review_card = tk.Frame(self.content_frame, bg="#161b22", padx=15, pady=15)
        review_card.pack(fill="both", expand=True)

        self._add_review_row(review_card, "GitHub Username:", self.values["github_username"])
        self._add_review_row(review_card, "GitHub Token:", self.values["github_token"][:20] + "...")
        self._add_review_row(review_card, "Mistral API Key:", self.values["mistral_api_key"][:20] + "...")
    ...
    def _add_review_row(self, parent, label, value):
        ...
        tk.Label(row, text=value,
                 font=("Consolas", 9),
                 bg="#161b22", fg="#79c0ff").pack(side="right")
    ...
    def _add_nav_buttons(self, step, is_final=False):
        ...
        if step > 1:
            tk.Button(btn_frame, text="← Back",
                      ...
                      command=lambda: self._go_back(step)).pack(side="left")

        if is_final:
            tk.Button(btn_frame, text="Start Agent →",
            ...
            tk.Button(btn_frame, text="Next →",
                      ...
                      bg="#238636", fg="white",
                      relief="flat", padx=20, pady=8, cursor="hand2",
                      command=lambda: self._go_next(step)).pack(side="right")
